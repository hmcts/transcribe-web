...
export default function RecordingControl({
  ...
  useEffect(() => {
    ...
    const isValidStream = stream?.active && stream.getAudioTracks().length > 0;
          ...
          <AlertDescription className="text-amber-900 dark:text-amber-100">
            <div className="flex items-center gap-2">
              ...
              <span>
                ...
                <br />
                Your recording will be automatically saved and uploaded when the
